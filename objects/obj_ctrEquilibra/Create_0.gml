...
palo = instance_create_layer(room_width/2, room_height - sprite_get_height(spr_piso) - sprite_get_height(spr_palo), "Instances", obj_palo);
base = instance_create_layer(room_width/2, palo.y + 4 - sprite_get_height(spr_base)/8, "Instances", obj_base);
