...
for(var i = 0; i < cantidad_numeros; i++) {
	...
	var inst = instance_create_layer(factor_escala*10 + i*width, room_height/2, "Instances", obj_cuadro_numero);
	...
	var btn = instance_create_layer(factor_escala*10*3/4 + i*width, room_height/2, "Instances", obj_control_swap);
	btn.image_xscale *= factor_escala/2;
	btn.image_yscale *= factor_escala;
}